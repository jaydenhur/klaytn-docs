...
The contract instance can be made through `caver.klay.Contract(ABI, contractAddress)` API of caver-js. For more details, see [caver.klay.Contract](../../../sdk/caver-js/v1.4.1/api-references/caver.klay.Contract.md#new-contract).
